import { FACEBOOK, INSTAGRAM, YOUTUBE } from "../../../config/config";


export const emailTemplate = async ({ code, title = 'confirmEmail' } : {code:number,title:string}) => {
    return `<!DOCTYPE html>
                <html>
                <head>
...
export const createTemplateOtp = async () => {
